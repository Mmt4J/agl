    ...
    <div class="space-y-2">
        @foreach ($faqs as $faq)
            <div class="flex items-start gap-3 rounded-md border border-ink-900/10 dark:border-linen-100/10 p-4">
                ...
                <button type="button" wire:click="confirmDelete({{ $faq->id }})" @click="$dispatch('open-modal', { name: 'confirm-delete' })" class="text-danger-500 shrink-0" aria-label="Delete this FAQ">
